 ...
 */function toggleAbstract(e){var t=document.getElementById(e),n=document.getElementById(e+"-link");t.style.display=="none"?(t.style.display="block",n.text="Hide Abstract"):(t.style.display="none",n.text="Show Abstract")}